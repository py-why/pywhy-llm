...
class IdentifierSuggestor(IdentifierProtocol):
    ...
    def backdoor_program(self, has_graph: bool = False) -> guidance._program.Program:
            ...
            if has_graph:
                ...
                '''
                {{#system~}}
                You are a causal inference expert and your task is to identify the backdoor set for a specific causal relationship given a set of variables confounding the relationship. The confounders are presented in a list, where each confounder are variables that, if unaccounted for, could lead to biased or incorrect estimates of the causal effect. Your task is to provide me with the backdoor set from the list of variables confounding the given causal relationship.
                ...
                To assist you, I will provide you with the causal relationship of interest and a list of variables confounding the relationship.
    ...
    def frontdoor_program(self, has_graph: bool = False) -> guidance._program.Program:
        ...
        if has_graph:
            ...
            '''
            {{#system~}}
            You are a helpful assistant with expertise in causal inference. Your task is to identify the frontdoor set for a specific causal relationship and a set of variables confounding the relationship. The confounders are presented in a list, where each confounder are variables that, if unaccounted for, could lead to biased or incorrect estimates of the causal effect.  Your task is to provide me with the frontdoor set for a given causal relationship.
    ...
    def iv_program(self, has_graph: bool = False) -> guidance._program.Program:
        ...
        if has_graph:
            ...
            '''
            {{#system~}}
            You are a helpful assistant with expertise in causal inference. Your task is to identify the instrumental variables set for a specific causal relationship given a set of variables confounding the relationship. The confounders are presented in a list, where each confounder are variables that, if unaccounted for, could lead to biased or incorrect estimates of the causal effect. Your task is to provide me with the instrumental variables set from the list of variables confounding the given causal relationship.
